...
def header(active):
    ...
    return ('<a href="#main" class="skip">Skip to content</a>'
      ...
      '<a href="index.html" aria-label="Woways — Execute, Grow, Transform" class="flex items-center gap-1.5 shrink-0">'
      '<img src="logo-icon.png" alt="" class="h-7 md:h-8 w-auto"/>'
      '<span class="w-px h-4 md:h-5 bg-white/20 mx-0.5" aria-hidden="true"></span>'
      '<img src="logo-word.png" alt="Woways" class="h-5 md:h-6 w-auto"/></a>'
